      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " updated in successfully"));
              photoPass = '/img/users/' + res.data.data.user.photo;
...
var stripe = Stripe('pk_test_51GxRllILYK9WUpFw5RT22vrkcGPYumgdFoO0IrW5MJ7XC82nEubGZzIYsw7X9xzPyqBvhmSPUUhbfgvizeqNF5fL00VE6rlhT3');
